...
\fbox{\includegraphics[scale=0.5]{ui-transaction-detail}}
...
\fbox{\includegraphics[scale=0.7]{ui-identity-view}}
...
\fbox{\includegraphics[scale=1]{result-one-stage}}
...
\begin{tabular}{cc}
\fbox{\includegraphics[scale=0.5]{result-multi-stage-1}}
&
\fbox{\includegraphics[scale=0.5]{result-multi-stage-2}}
\end{tabular}
...
\fbox{\includegraphics[scale=0.6]{result-remix-ide}}
...
\fbox{\includegraphics[scale=0.8]{result-slither}}
...
\fbox{\includegraphics[scale=0.4]{result-smartcheck}}
