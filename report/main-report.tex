...
%nonumberlist, nopostdot, nogroupskip
...
\def \TITLE{KHÓA LUẬN TỐT NGHIỆP}
\def \AUTHOR{NGUYỄN THANH TÙNG, LÊ HOÀNG TUẤN}

\newcommand{\titlesize}{\fontsize{18pt}{23pt}\selectfont}
\newcommand{\subtitlesize}{\fontsize{16pt}{21pt}\selectfont}
\titleclass{\part}{top}
\titleformat{\part}[display]
  {\normalfont\huge\bfseries}{\centering}{20pt}{\Large\centering}
...
\begin{document}
\newgeometry{top=2cm, bottom=2cm, left=2cm, right=1.8cm}
\subfile{pages/Cover} % Phần bìa
\restoregeometry

\pagestyle{empty} % Header và footer rỗng
\newpage
\pagenumbering{gobble} % Xóa page numbering ở cuối trang
\subfile{pages/ListOfBoard} % Danh sách hội đồng

\newpage
\pagenumbering{gobble} % Xóa page numbering ở cuối trang
\subfile{pages/Acknowledgement} % Lời cảm ơn
...
\renewcommand*{\descriptionname}{Diễn giải}
%\renewcommand*{\pagelistname}{Trang}
\printnoidxglossary
\newpage
\renewcommand*{\entryname}{Từ viết tắt}
\renewcommand*{\descriptionname}{Từ đầy đủ}
  %\printglossary[type=\acronymtype]
\printnoidxglossary[type=\acronymtype]
\newpage

\subfile{pages/Summarize} % Tóm tắt

\newpage
\pagestyle{fancy} % Áp dụng header và footer
\chapter{MỞ ĐẦU}
\subfile{chapters/chap1_mo_dau}

\chapter{TỔNG QUAN}
\subfile{chapters/chap2_tong_quan}

\chapter{PHÂN TÍCH VÀ THIẾT KẾ HỆ THỐNG}
\subfile{chapters/chap3_phan_tich_va_thiet_ke}

\chapter{HIỆN THỰC VÀ ĐÁNH GIÁ HỆ THỐNG}
\subfile{chapters/chap4_hien_thuc}

\chapter{KẾT LUẬN}
\subfile{chapters/chap5_ket_luan}
